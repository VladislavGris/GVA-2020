...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY(304, "Ошибка в параметрах вызываемой функции"),ERROR_ENTRY(305, "Ошибка в условии оператора if"),ERROR_ENTRY(306, "Ошибка в конструкции условного оператора"),
		...
		ERROR_ENTRY_NODEF100(400),ERROR_ENTRY_NODEF100(500),ERROR_ENTRY_NODEF100(600),ERROR_ENTRY_NODEF100(700),ERROR_ENTRY_NODEF100(800),ERROR_ENTRY_NODEF100(900)
	};
