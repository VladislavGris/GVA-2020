...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY(400, "Несоответствие типов операндов в выражении условного оператора"),ERROR_ENTRY(401, "Тип возвращаемого значения не соответствует типу возвращаемого значения функиции"),ERROR_ENTRY_NODEF(402),ERROR_ENTRY_NODEF(403),ERROR_ENTRY_NODEF(404),ERROR_ENTRY_NODEF(405),ERROR_ENTRY_NODEF(406),ERROR_ENTRY_NODEF(407),
		ERROR_ENTRY_NODEF(408),ERROR_ENTRY_NODEF(409),ERROR_ENTRY_NODEF10(410), ERROR_ENTRY_NODEF10(420),ERROR_ENTRY_NODEF10(430),ERROR_ENTRY_NODEF10(440),ERROR_ENTRY_NODEF10(450),ERROR_ENTRY_NODEF10(460),ERROR_ENTRY_NODEF10(470),
